...
class Board():
    ...
    def is_win(self):
        ...
        for col in range(3):
            ...
            for row in range(3):
                ...
                if self.position[row, col] == self.player_2:
                    ...
                    winning_sequnece.append((row, col))

                # if we have 3 elements in the row or col 
                if len(winning_sequnece) == 3:
        ...
        #################################
        # 2nd diagonal sequnece detection
        #################################
        ...
        # by default we return lose
        return False
    
    # generate legal moves to play in current position
    def generate_states(self):
        # define states list (move list - list of avaiable action to consider)
        actions = []
