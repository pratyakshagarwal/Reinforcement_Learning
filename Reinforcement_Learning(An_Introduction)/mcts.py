...
class MCTS():
    ...
    def search(self, initial_state):
        ...
        for iteration in range(1000):
            ...
            # score for current node (simulation phase)
    ...
    def expand(self, node):
        # genrate legal states (moves) for the given node
        ...
        for state in states:
            ...
            if str(state.position) not in node.children:
                ...
                # case for when node is fully expanded
    ...
    # simulate the game via making random values until reach end of the game 
